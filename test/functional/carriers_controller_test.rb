...
class CarriersControllerTest < ActionController::TestCase
  ...
  test "should create carrier" do
    assert_difference('Carrier.count') do
      post :create, carrier: { basic_carrier: @carrier.basic_carrier, expired_date: @carrier.expired_date, requirement: @carrier.requirement, title: @carrier.title }
    end
  ...
  test "should update carrier" do
    put :update, id: @carrier, carrier: { basic_carrier: @carrier.basic_carrier, expired_date: @carrier.expired_date, requirement: @carrier.requirement, title: @carrier.title }
    assert_redirected_to carrier_path(assigns(:carrier))
  end
